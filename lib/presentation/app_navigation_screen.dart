...
class AppNavigationScreen extends StatelessWidget {
  ...
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the qrCodeScreen.
  onTapQRCODE(BuildContext context) {
  ...
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the landingPageScreen.
  onTapLANDINGPAGE(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.landingPageScreen);
  }

  /// Navigates to the callSmsScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the callSmsScreen.
  onTapCALLSMS(BuildContext context) {
  ...
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the reportScreen.
